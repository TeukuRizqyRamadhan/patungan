...
export default function SplitBillCalculator() {
    ...
    const finalTotal = totalValue + totalPPN;
        ...
        <div className="container">
            <div className="content">
                ...
                <div className="card">
                    ...
                    <select value={people} onChange={handlePeopleChange} className="input full-width white-bg">
                    ...
                    <p className="result">Total Akhir (Termasuk PPN): Rp {formatCurrency(finalTotal.toFixed(0))}</p>
                </div>
            </div>
        </div>
    );
